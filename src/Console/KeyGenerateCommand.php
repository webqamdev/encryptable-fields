...
class KeyGenerateCommand extends \Illuminate\Foundation\Console\KeyGenerateCommand
{
    ...
    {
        $currentKey = $this->laravel['config']['encryptable-fields.key'];
    ...
    {
        $escaped = preg_quote('='.$this->laravel['config']['encryptable-fields.key'], '/');

        return "/^APP_DB_ENCRYPTION_KEY{$escaped}/m";
    }
